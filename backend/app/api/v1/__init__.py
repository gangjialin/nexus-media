...
from app.api.v1 import auth, users, projects, scripts, annotations, assets, reviews, tasks, notifications, search
...
router.include_router(annotations.router, prefix="/annotations", tags=["批注"])
